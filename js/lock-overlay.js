export async function enableLockOverlay(build){
  ...
  function apply(){
    ...
    const lx=lakeStart+(100-lakeStart)/2;
    lakeLabel.setAttribute('x',lx);lakeLabel.setAttribute('y','61');lakeLabel.setAttribute('text-anchor','middle');lakeLabel.setAttribute('class','lake-label');
